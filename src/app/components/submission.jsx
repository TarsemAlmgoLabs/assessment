...
export default function AssessmentResult() {
  ...
  const passed = result.obtainedMarks >= result.passingMarks;
  ...
  return (
    ...
    >
      ...
      <header
        className={`sticky top-0 z-40 border-b backdrop-blur-xl transition-colors duration-300 ${
          isLight
            ...
            : "border-white/[0.06] bg-[#0b1119]/95"
        }`}
      >
        <div className="mx-auto flex h-[68px] max-w-6xl items-center justify-between px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className={`flex h-9 w-9 items-center justify-center rounded-xl border transition-all ${
                isLight
                  ? "border-slate-200 bg-slate-100 text-slate-600 hover:border-cyan-300 hover:bg-cyan-50 hover:text-cyan-600"
                  : "border-white/[0.08] bg-white/[0.03] text-slate-400 hover:border-cyan-400/30 hover:bg-cyan-400/10 hover:text-cyan-400"
              }`}
            >
      ...
      <main className="relative mx-auto max-w-6xl px-4 py-6 sm:px-6 sm:py-8 lg:px-8">
        {/* Background glow */}
        <div
          className={`pointer-events-none fixed left-1/2 top-0 -z-10 h-[500px] w-[700px] -translate-x-1/2 rounded-full blur-[120px] ${
            isLight ? "bg-cyan-500/[0.04]" : "bg-cyan-500/[0.025]"
          }`}
        />
        ...
        <section
          className={`overflow-hidden rounded-2xl border shadow-[0_10px_40px_rgba(0,0,0,0.08)] transition-colors duration-300 ${
            isLight
              ? "border-slate-200 bg-white"
              : "border-white/[0.07] bg-[#0d141e]"
          }`}
        >
          <div className="p-6 sm:p-8">
            <div className="text-center">
              ...
              <div className="mt-6">
                <div
                  className={`text-5xl font-black tracking-tight sm:text-6xl ${
                    passed ? "text-cyan-500" : "text-red-500"
                  }`}
                >
                  {percentage}%
                </div>
            ...
            {result.questions.map((question) => {
              ...
              return (
                <QuestionResult
                  ...
                  isSkipped={isSkipped}
                  isReported={!!reportedQuestions[question.id]}
                  onReport={() => openReportModal(question)}
                  theme={theme}
                />
              );
            })}
        ...
        <div className="flex justify-center py-8">
          <Link
            href="/"
            className={`flex items-center justify-center gap-2 rounded-xl border px-6 py-3 text-sm font-semibold shadow-sm transition-all ${
              isLight
                ? "border-slate-200 bg-white text-slate-600 hover:border-slate-300 hover:bg-slate-50"
                : "border-white/[0.08] bg-[#0d141e] text-slate-300 hover:border-white/[0.15] hover:bg-[#111a25]"
            }`}
          >
            <ArrowLeft size={17} />
            Back to Assessments
      ...
      {reportQuestion && (
        ...
        >
          <div
            className={`w-full max-w-lg overflow-hidden rounded-2xl border shadow-[0_25px_80px_rgba(0,0,0,0.25)] ${
              isLight
                ? "border-slate-200 bg-white"
                : "border-white/[0.08] bg-[#0d141e]"
            }`}
          >
            {/* Modal Header */}
            <div
            ...
            >
              <div className="flex items-start gap-3">
                <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl border border-red-400/15 bg-red-400/10 text-red-500">
                  <Flag size={18} />
                </div>
            ...
            <div className="space-y-5 p-5 sm:p-6">
              ...
              <div>
                ...
                <select
                  ...
                  className={`w-full rounded-xl border px-3.5 py-3 text-sm outline-none transition-all focus:border-cyan-400/40 focus:ring-2 focus:ring-cyan-400/10 ${
                    isLight
                      ? "border-slate-200 bg-white text-slate-700"
                      : "border-white/[0.08] bg-[#111a25] text-slate-300"
                  }`}
                >
              ...
              <div>
                ...
                <textarea
                  ...
                  maxLength={500}
                  placeholder="Describe the issue with this question..."
                  className={`w-full resize-none rounded-xl border px-3.5 py-3 text-sm outline-none transition-all placeholder:text-slate-400 focus:border-cyan-400/40 focus:ring-2 focus:ring-cyan-400/10 ${
                    isLight
                      ? "border-slate-200 bg-white text-slate-700"
                      : "border-white/[0.08] bg-[#111a25] text-slate-300 placeholder:text-slate-600"
                  }`}
                />
            ...
            {/* Modal Footer */}
            <div
              className={`flex flex-col-reverse gap-2 border-t p-5 sm:flex-row sm:justify-end sm:p-6 ${
                isLight ? "border-slate-200" : "border-white/[0.06]"
              }`}
            >
              <button
              ...
              <button
                onClick={submitReport}
                disabled={!reportReason}
                className="flex items-center justify-center gap-2 rounded-xl bg-cyan-400 px-5 py-2.5 text-sm font-bold text-[#061016] transition-all hover:bg-cyan-300 disabled:cursor-not-allowed disabled:opacity-40"
              >
                <Flag size={15} />
                Submit Report
              </button>
...
function QuestionResult({
  ...
  return (
    <div
      className={`overflow-hidden rounded-2xl border shadow-[0_5px_25px_rgba(0,0,0,0.08)] ${
        isLight ? "bg-white" : "bg-[#0d141e]"
      } ${
        isCorrect
        ...
        <div className="min-w-0 flex-1">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
            ...
            <button
              onClick={onReport}
              disabled={isReported}
              className={`flex shrink-0 items-center justify-center gap-1.5 self-start rounded-lg border px-2.5 py-1.5 text-[10px] font-semibold transition-all ${
                isReported
                  ? isLight
                    ? "cursor-default border-emerald-200 bg-emerald-50 text-emerald-600"
                    : "cursor-default border-emerald-400/10 bg-emerald-400/[0.05] text-emerald-500"
                  : isLight
                    ? "border-slate-200 bg-slate-50 text-slate-500 hover:border-red-300 hover:bg-red-50 hover:text-red-500"
                    : "border-white/[0.07] bg-white/[0.02] text-slate-500 hover:border-red-400/20 hover:bg-red-400/[0.06] hover:text-red-400"
              }`}
            >
              {isReported ? (
      ...
      <div className="grid gap-3 p-5 sm:grid-cols-2 sm:p-6">
        {question.options.map((option, index) => {
          ...
          return (
            <div
              key={option}
              className={`flex min-w-0 items-center gap-3 rounded-xl border p-3.5 sm:p-4 ${optionStyle}`}
            >
              <span
                className={`flex h-9 w-9 shrink-0 items-center justify-center rounded-lg border text-xs font-bold sm:h-10 sm:w-10 ${badgeStyle}`}
              >
                {String.fromCharCode(65 + index)}
              </span>
              ...
              {isAnswer && (
                <div className="flex shrink-0 items-center gap-1.5 text-[9px] font-bold uppercase tracking-wide text-emerald-500">
                  <Check size={15} />
                  Correct
                </div>
              )}
              ...
              {isSelected && !isAnswer && (
                <div className="flex shrink-0 items-center gap-1.5 text-[9px] font-bold uppercase tracking-wide text-red-500">
                  <X size={15} />
                  Your Answer
                </div>
              )}
...
function ResultStat({ label, value, variant, theme }) {
  const isLight = theme === "light";
